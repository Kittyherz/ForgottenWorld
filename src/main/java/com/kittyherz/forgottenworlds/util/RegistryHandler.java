...
import com.kittyherz.forgottenworlds.world.biomes.BlueSpotsBiome;
...
public class RegistryHandler {
    ...
    //public static final DeferredRegister<Block> BIOMES = new DeferredRegister<>(ForgeRegistries.BIOMES, ForgottenWorlds.MOD_ID);
    ...
    //Biomes
    //public static final RegistryObject<Biome> BLUE_SPOTS_BIOME = BIOMES.register("blue_spots_biome", () -> new BlueSpotsBiome(() -> ));

    //Entities
    //public static final RegistryObject<EntityType<TestMob>> TEST_MOB = ENTITY_TYPES.register("testmob", () -> EntityType.Builder.<TestMob>create(TestMob::new, EntityClassification.MONSTER).size(0.9F, 1.3F).build(new ResourceLocation(ForgottenWorlds.MOD_ID, "test_mob").toString()));
}
